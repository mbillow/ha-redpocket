...
class RedPocketBaseFlowHandler(config_entries.ConfigFlow):
    async def _test_credentials(self, username, password):
        """Return true if credentials is valid."""
        try:
            await self.hass.async_add_executor_job(RedPocket, username, password)
            return True
...
class RedPocketFlowHandler(RedPocketBaseFlowHandler, domain=DOMAIN):
...
class OptionsFlowHandler(RedPocketBaseFlowHandler, config_entries.OptionsFlow):
